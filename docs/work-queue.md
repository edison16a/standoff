...
| Review loop, Boxing and Subway Runner | `worktree-wf_0e9b8a84-bad-3` | first pass done, second pass to run |
| Review loop, Basketball 3v3 and Soccer 3v3 | `worktree-wf_0e9b8a84-bad-4` | first pass running |
| Review loop, Cube Game and Brawl Battle | `worktree-wf_0e9b8a84-bad-5` | first pass running |
| Blade Clash (replaces Fencing) | `worktree-wf_24155454-673-1` | gameplay done, look and sound running, then media and review |
| Counter Battle (new game) | `worktree-wf_d726d4b1-caf-1` | engine, world and play done; media running, then review |
| Phone cannot join a new room after one game | `worktree-wf_74602659-578-4` | fix committed and passing its checks; adversarial check running |
