...
An endless runner on the rails, played from the waist up in front of the computer's camera. No phones: a pose model downloads once to the computer and runs in the browser, and the camera picture never leaves it.
