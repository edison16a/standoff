...
export const CHARACTERS: Record<CharacterId, Character> = {
  karate: {
    ...
    color: "#f8fafc",
    physique: { run: 7.6, air: 5.6, accel: 60, airAccel: 30, jump: 13.2, doubleJump: 12, gravity: 36, fall: 15, fastFall: 22, weight: 92, width: 0.8, height: 1.75 },
  },
  samurai: {
    id: "samurai",
    name: "Samurai",
    ...
    color: "#dc2626",
    physique: { run: 6.6, air: 5, accel: 50, airAccel: 26, jump: 12.6, doubleJump: 11.6, gravity: 36, fall: 15.5, fastFall: 22.5, weight: 98, width: 0.8, height: 1.85 },
  },
  mage: {
    id: "mage",
    name: "Mage",
    ...
    color: "#7c3aed",
    physique: { run: 5.8, air: 5.2, accel: 42, airAccel: 28, jump: 12.4, doubleJump: 12.4, gravity: 30, fall: 12.5, fastFall: 19, weight: 82, width: 0.75, height: 1.8 },
  },
  bear: {
    id: "bear",
    name: "Bear",
    ...
    color: "#92400e",
    physique: { run: 5.6, air: 4.4, accel: 38, airAccel: 20, jump: 12.8, doubleJump: 11, gravity: 40, fall: 17, fastFall: 24, weight: 124, width: 1.25, height: 2.1 },
  },
};
