...
export const SAMURAI: Moveset = {
  ...
  side: {
    ...
    frames: 28,
    sound: "slash",
    hitboxes: [box(1.0, 1.1, 0.6, 7, 10, hit(10, 7, 0.15, 35)), box(1.9, 1.0, 0.5, 7, 10, hit(10, 7, 0.15, 35))],
  },
  up: {
    name: "Arc Slash",
    frames: 28,
  ...
  airUp: { name: "Rising Arc", frames: 26, sound: "slash", landLag: 7, hitboxes: [box(0.5, 2.2, 0.7, 5, 10, hit(9, 7, 0.13, 85))] },
  ...
  heavy: {
    ...
    sound: "slash",
    heavy: true,
    hitboxes: [box(1.4, 1.1, 0.6, 14, 17, hit(15, 9, 0.22, 35)), box(2.4, 1.1, 0.55, 14, 17, hit(15, 9, 0.22, 35))],
  },
  heavySide: {
    name: "Dash Cut",
    frames: 38,
  ...
  heavyDown: { name: "Ground Slash", frames: 36, sound: "slash", heavy: true, hitboxes: both(1.6, 0.3, 0.6, 10, 14, hit(13, 9, 0.2, 25)) },
  ult: {
    name: "Thousand Cuts",
    frames: 80,
    sound: "slash",
    ...
    hitboxes: [
      ...
      box(1.5, 1.2, 1.3, 52, 56, hit(18, 17, 0.24, 40), 5),
      box(3, 1.2, 1.3, 52, 56, hit(18, 17, 0.24, 40), 5),
      box(4.5, 1.2, 1.3, 52, 56, hit(18, 17, 0.24, 40), 5),
    ],
  },
};
