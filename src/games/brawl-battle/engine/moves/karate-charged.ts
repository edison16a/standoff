...
export const KARATE_CHARGED: ChargedSet = {
  holdSide: {
    ...
    hitboxes: [box(1.0, 1.1, 0.7, 6, 8, hit(4, 4, 0.02, 40), 0), box(1.1, 1.1, 0.75, 12, 15, hit(12, 10, 0.2, 38), 1)],
  },
  holdUp: {
    ...
    hitboxes: [box(0.5, 1.6, 0.75, 6, 9, hit(5, 6, 0.03, 85), 0), box(0.4, 2.1, 0.8, 10, 15, hit(11, 10, 0.2, 85), 1)],
  },
  holdDown: { name: "Split Kick", frames: 32, sound: "kick", heavy: true, root: true, hitboxes: both(1.2, 0.4, 0.7, 7, 11, hit(12, 10, 0.19, 28)) },
  holdHeavy: {
    name: "Dragon Flight",
    frames: 44,
    sound: "kick",
    ...
    hitboxes: [box(0.9, 1.0, 0.75, 8, 22, hit(14, 11, 0.22, 35))],
  },
  holdHeavyDown: {
    name: "Heel Drop",
    frames: 42,
