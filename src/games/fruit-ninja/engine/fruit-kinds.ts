...
export const KINDS: Record<BodyKind, KindInfo> = {
  watermelon: common(0.9, 10, 1.2),
  orange: common(0.56, 10, 1.2),
  apple: common(0.54, 10, 1.1),
  "green-apple": common(0.52, 10, 0.8),
  banana: common(0.62, 10, 1),
  pineapple: common(0.66, 10, 0.8),
  kiwi: common(0.42, 15, 0.9),
  coconut: common(0.6, 10, 0.7),
  strawberry: common(0.42, 15, 1),
  lemon: common(0.48, 10, 0.9),
  lime: common(0.42, 15, 0.7),
  plum: common(0.44, 15, 0.8),
  peach: common(0.52, 10, 0.9),
  "giant-melon": { radius: 1.3, points: 0, class: "big", hits: 7, weight: 1 },
  pomegranate: { radius: 0.82, points: 0, class: "big", hits: 5, weight: 1 },
  "star-fruit": { radius: 0.55, points: 60, class: "rare", hits: 1, weight: 1 },
  dragonfruit: { radius: 0.62, points: 80, class: "rare", hits: 1, weight: 0.8 },
  bomb: { radius: 0.56, points: 0, class: "common", hits: 1, weight: 0 },
};
