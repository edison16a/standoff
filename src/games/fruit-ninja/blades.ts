...
export const BLADES: Record<BladeId, BladeLook> = {
  ...
  ice: { name: "Ice", blurb: "Frost that leaves snow behind", core: "#ffffff", glow: "#4fd8ff", accent: "#9fefff", motion: "shimmer" },
  ...
  gold: { name: "Gold", blurb: "Polished gold with glitter", core: "#fffbe8", glow: "#ffae00", accent: "#ffd84a", motion: "shimmer" },
};
