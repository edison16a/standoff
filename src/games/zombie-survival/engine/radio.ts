...
const ON_THE_WAY: Record<number, RadioLine> = {
  ...
  8: { from: PILOT, text: "Hospital dead ahead. Big ones in the ambulance bay. They soak up body shots, so aim for the head." },
  ...
  13: { from: HARBOR, text: "More of the big ones on this road. Heads, not bodies. Save your rounds." },
