...
import type { FencerAction, FencerFrame, StageFrame } from "@/games/blade-clash/engine/frames";
import type { FixedShot } from "@/games/blade-clash/render/camera-director";
