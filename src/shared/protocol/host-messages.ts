...
export const tuningMessageSchema = z.object({
  ...
  tuning: z.object({
    ...
    movementMode: z.enum(["position", "tilt"]),
    stillnessThreshold: z.number(),
    stillnessMs: z.number(),
    moveFullScaleM: z.number(),
    moveDeadzoneM: z.number(),
    tiltDeadzoneDeg: z.number(),
    tiltFullScaleDeg: z.number(),
